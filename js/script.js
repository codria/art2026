...
function initEntryOrders() {
  ...
  entryOrders.award = idsFromEls(document.querySelectorAll('.entry.taisho, .entry.kinsho, .entry.ginsho, .entry.dousho, .entry.nyuusho'));
  entryOrders.all_2026 = idsFromEls(document.querySelectorAll('.entry[data-year="2026"]:not(.top6):not(.taisho):not(.kinsho):not(.ginsho):not(.dousho):not(.nyuusho)'));
  entryOrders.all_2025 = idsFromEls(document.querySelectorAll('.entry[data-year="2025"]:not(.top6):not(.taisho):not(.kinsho):not(.ginsho):not(.dousho):not(.nyuusho)'));
}
...
function isAwardEntry(el) {
  return el.classList.contains('taisho') || el.classList.contains('kinsho')
      || el.classList.contains('ginsho') || el.classList.contains('dousho')
      || el.classList.contains('nyuusho');
}
